...
*/
        document.getElementById('ir-a-seccion').addEventListener('click', function() {
            var destino = document.getElementById('seccion-destino');
...
/*********************** 1-SELECCIONAR ELEMENTOS  ********************/
const btnOpenCart = document.getElementById('carritoBTN');
